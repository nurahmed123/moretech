      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
            Have questions about our smart wheelchair? We'd love to hear from you!
          </p>
        </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">+880 1712 345678</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">info@moretechbd.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">Technology Hub, Dhaka, Bangladesh</p>
                    </div>
                  </div>
                </div>
              </div>
