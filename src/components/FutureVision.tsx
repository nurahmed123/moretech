...
import { LightbulbIcon, FlaskConical, Users, GraduationCap, Globe } from 'lucide-react';
  ...
  const roadmapItems = [
    {
      ...
      description: "Implementing next-generation machine learning algorithms to improve predictive capabilities and user experience.",
      icon: <LightbulbIcon className="h-6 w-6" />
    },
    {
      year: "2026",
      title: "Expanded Research",
      description: "Partnering with leading medical institutions to advance the therapeutic benefits of our smart mobility solutions.",
      icon: <FlaskConical className="h-6 w-6" />
    },
    {
      year: "2027",
      title: "Global Accessibility Initiative",
      description: "Launching programs to make our technology available in underserved communities worldwide.",
      icon: <Globe className="h-6 w-6" />
    },
    {
      year: "2028",
      title: "Education & Training Center",
      description: "Establishing a center of excellence for innovation in assistive technology and accessibility solutions.",
      icon: <GraduationCap className="h-6 w-6" />
    },
    {
      year: "2029",
      title: "Community Development",
      description: "Creating a global network of users, caregivers, and healthcare professionals to share insights and experiences.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
            We're committed to continuously advancing assistive technology and expanding our impact globally.
          </p>
        </div>
        ...
        >
          ...
          <div className="relative">
            <h3 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-900 dark:text-white">Redefining Mobility Through Innovation</h3>
            <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 max-w-3xl">
              At MoreTechBD, we envision a world where mobility limitations no longer restrict human potential. Our mission is to harness the power of artificial intelligence and cutting-edge technology to create solutions that enhance independence, dignity, and quality of life for wheelchair users everywhere.
            </p>
            ...
            <div className="flex flex-wrap gap-6">
              <div className="flex items-center">
                ...
                <div className="text-gray-900 dark:text-white font-medium">Continuous Innovation</div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="text-gray-900 dark:text-white font-medium">Global Accessibility</div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="text-gray-900 dark:text-white font-medium">Research-Driven Approach</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Future Roadmap */}
        <div className="mb-20">
          <h3 className="text-2xl font-bold mb-10 text-center text-gray-900 dark:text-white">Our Future Roadmap</h3>
        ...
        >
          <div className="inline-block p-1 bg-gradient-to-r from-purple-600 to-indigo-500 rounded-xl">
            <div className="bg-white dark:bg-gray-800 rounded-lg px-8 py-6">
              <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Be Part of Our Journey</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
                Whether you're a potential user, healthcare professional, investor, or technology enthusiast, we invite you to join us in shaping the future of mobility.
              </p>
              <a 
                href="#contact" 
